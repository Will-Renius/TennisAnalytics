...
library(ROCR)
data(ROCR.simple)
printCM = table(test.data$print_favorite_won, reg.pred$prediction)
  accuracy = (sum(diag(CM)))/sum(CM)
  print(CM)
  print(accuracy)CM = table(test.data$print_favorite_won, reg.pred$prediction)
  accuracy = (sum(diag(CM)))/sum(CM)
  print(CM)
  print(accuracy)CM = table(test.data$print_favorite_won, reg.pred$prediction)
  accuracy = (sum(diag(CM)))/sum(CM)
  print(CM)
  print(accuracy)ZZZZZZ
